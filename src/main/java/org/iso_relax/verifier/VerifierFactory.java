...
public abstract class VerifierFactory
{
  ...
  /**
   * parses a schema at the specified location and returns a Verifier object that validates
   * documents by using that schema.
   * <p>
   * Some of XML parsers accepts filenames as well as URLs, while others reject them. Therefore, to
   * parse a file as a schema, you should use a File object.
   *
   * @param uri
  ...
  /**
   * parses a schema from the specified file and returns a Verifier object that validates documents
   * by using that schema.
   *
   * @param file
  ...
  /**
   * parses a schema from the specified InputSource and returns a Verifier object that validates
   * documents by using that schema.
   *
   * @param source
  ...
  /**
   * Sets an EntityResolver This entity resolver is used to resolve entities encountered while
   * parsing a schema.
   */
  ...
  /**
   * Gets the current entity resolver, which was set by the <code>SetEntityResolver</code> method.
   */
   ...
   *        <p>
   *        It is preferable to use the namespace URI of the schema language to designate the schema
   *        language. For example,
   *        <table>
   *        <caption>possibilities</caption><thead>
   *        <tr>
   *        <th>URI</th>
   *        <th>language</th>
   *        </tr>
   *        </thead><tbody>
   *        <tr>
   *        <td><code>http://relaxng.org/ns/structure/0.9</code></td>
   *        <td><a href="http://www.oasis-open.org/committees/relax-ng/"> RELAX NG </a></td>
   *        </tr>
   *        <tr>
   *        <td><code>http://www.xml.gr.jp/xmlns/relaxCore</code></td>
   *        <td><a href="http://www.xml.gr.jp/relax"> RELAX Core </a></td>
   *        </tr>
   *        <tr>
   *        <td><code>http://www.xml.gr.jp/xmlns/relaxNamespace</code></td>
   *        <td><a href="http://www.xml.gr.jp/relax"> RELAX Namespace </a></td>
   *        </tr>
   *        <tr>
   *        <td><code>http://www.thaiopensource.com/trex</code></td>
