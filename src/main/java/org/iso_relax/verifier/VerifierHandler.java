 ...
 * <p>
 * An instance of this interface can be obtained through the {@link Verifier#getVerifierHandler}
 * method.
 * <p>
 * The implementation validates incoming SAX events. The application can check the result by calling
 * the isValid method.
 *
 * @since Feb. 23, 2001
 * @version Feb. 24, 2001
...
public interface VerifierHandler extends ContentHandler
{
   ...
   * <p>
   * This method can be only called after this handler receives the <code>endDocument</code> event.
   * <p>
   * If you need to know the error at an earlier moment, you should set an error handler to
   * {@link Verifier}.
   *
