 ...
 * <p>
 * Implementations of this interface are discovered through <code>META-INF/services</code>, just
 * like JAXP. This object then provides VerifierFactory implementation for the specified schema
 * language.
 *
...
{
  /**
   * returns a VerifierFactory that supports the specified schema language, or returns null if it's
   * not supported.
   */
